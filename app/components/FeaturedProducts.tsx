...
export default function FeaturedProducts({
  ...
  return (
    <section className="w-full py-24 bg-chestnut">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 max-w-6xl mx-auto px-6">
        {visibleProducts.map((product) => (
          <Link
            ...
            className="bg-driftwood p-6 rounded-xl shadow hover:scale-[1.02] transition"
          >
      ...
      <div className="flex justify-center mt-12">
        <Link href="/shop">
          <button className="px-8 py-2 border border-driftwood text-walnut bg-driftwood text-shadow-lg font-semibold rounded-full cursor-pointer hover:bg-background hover:text-sandstone transition">
            View Products
          </button>
        </Link>
      </div>
